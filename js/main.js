...
$("#github")
  .mouseover(function () {
    $("#link-text").html("去 Github 看看（不给你）");
  })
  .mouseout(function () {
...
$("#email")
  .mouseover(function () {
    $("#link-text").html("来封 Email（这个可以给你）");
  })
  .mouseout(function () {
    $("#link-text").html("通过这里联系我");
  });
...
$("#telegram")
  .mouseover(function () {
    $("#link-text").html("你懂的 ~（这个我根本没有）");
  })
  .mouseout(function () {
    $("#link-text").html("不通过这里联系我");
  });
